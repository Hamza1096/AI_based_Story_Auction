      ...
      <header className="relative z-20 border-b border-white/5 bg-[#0c1220]/80 backdrop-blur-sm sticky top-0">
        <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="text-sm font-serif text-amber-100/80 hidden sm:block">The Astral Loom</span>
          </Link>

          <nav className="flex items-center gap-1 text-sm">
            <Link href="/dashboard" className="px-3 py-1.5 rounded-lg text-stone-400 hover:text-stone-200 hover:bg-white/5 text-xs transition-all">Dashboard</Link>
            <Link href="/stories"   className="px-3 py-1.5 rounded-lg text-stone-400 hover:text-stone-200 hover:bg-white/5 text-xs transition-all">Browse Stories</Link>
            <span className="px-3 py-1.5 rounded-lg text-amber-300 bg-amber-500/10 font-medium text-xs">Wallet</span>
          </nav>
        </div>
      </header>
