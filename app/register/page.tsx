...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#0c1222] text-stone-800 font-sans selection:bg-amber-800/20">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 md:py-24 relative overflow-y-auto bg-[#Fdfbf7] dark:bg-[#181615] transition-colors duration-500">
        ...
        <div className="w-full max-w-md relative z-10 p-8 sm:p-12 rounded-sm bg-white/60 dark:bg-black/20 shadow-2xl shadow-stone-200/50 dark:shadow-none border border-stone-200/60 dark:border-stone-800/40 my-auto">
          
          <div className="mb-10 text-center">
            <h1 className="font-serif text-3xl text-stone-800 dark:text-stone-200 mb-3">Begin Your Story</h1>
            <p className="text-stone-500 dark:text-stone-400 font-serif italic">Step into a world woven by many.</p>
          </div>

          {error && (
            <div className="mb-6 p-4 rounded-sm bg-[#fff0ed] dark:bg-[#3d1810] border border-[#f5d6cc] dark:border-[#522b22] text-[#803120] dark:text-[#f2afa1] text-sm flex items-start gap-3">
          ...
          {success && (
            <div className="mb-6 p-4 rounded-sm bg-[#eefaf4] dark:bg-[#113123] border border-[#c3eed8] dark:border-[#1d523b] text-[#216d47] dark:text-[#76ce9f] text-sm flex items-start gap-3">
              <svg className="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative group">
              <input
                ...
                required
                className="peer w-full bg-transparent border-b border-stone-300 dark:border-stone-700 px-2 pt-6 pb-2 text-stone-800 dark:text-stone-200 focus:outline-none focus:border-amber-700 transition-colors duration-300 rounded-none shadow-none [color-scheme:light] dark:[color-scheme:dark]"
              />
              <label 
                htmlFor="dateOfBirth" 
                className="absolute left-2 top-1 text-xs text-stone-400 dark:text-stone-500 font-serif transition-all duration-300 pointer-events-none peer-focus:text-amber-700 peer-valid:text-stone-500"
              >
                Origin Date
              </label>
            </div>
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={loading}
                className="w-full relative group overflow-hidden rounded-sm disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-300 transform active:scale-95 bg-[#C66743] hover:bg-[#Af5533] dark:bg-[#974d2f] dark:hover:bg-[#854024] shadow-md hover:shadow-lg border border-white/10"
              >
                <div className="relative flex items-center justify-center py-3.5 px-4">
                  {loading ? (
                    ...
                    <span className="text-amber-50 font-serif tracking-wide text-lg">Cross the Threshold</span>
                  )}
                </div>
              </button>
            </div>
          ...
          <div className="mt-8 flex items-center justify-center space-x-4">
            ...
            <p className="text-xs text-stone-400 dark:text-stone-600 uppercase tracking-widest font-serif">or</p>
            <div className="flex-1 h-px bg-stone-200 dark:bg-stone-800"></div>
          </div>
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full py-3.5 bg-white dark:bg-[#1f1d1c] hover:bg-stone-50 dark:hover:bg-[#252220] rounded-sm border border-stone-200 dark:border-stone-700 flex items-center justify-center transition-all duration-300 gap-3 shadow-sm hover:shadow active:scale-95"
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 text-stone-700 dark:text-stone-300" aria-hidden="true">
                <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                <path fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
                <path fill="currentColor" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
                <path fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
              </svg>
              <span className="text-stone-700 dark:text-stone-300 font-serif text-md tracking-wide">Continue with Google</span>
            </button>
          </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-stone-500 font-serif">
              ...
              <Link
                href="/login"
                className="text-amber-700 dark:text-amber-500 hover:text-amber-800 dark:hover:text-amber-400 transition-colors border-b border-transparent hover:border-amber-700 pb-0.5 italic"
              >
