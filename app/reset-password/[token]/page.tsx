      ...
      <div className="w-full max-w-md relative z-10 p-8 sm:p-12 rounded-sm bg-[#Fdfbf7] dark:bg-[#181615] shadow-2xl border border-stone-200/60 dark:border-stone-800/40">
        ...
        <div className="relative z-10">
          <div className="mb-10 text-center">
            <h1 className="font-serif text-3xl text-stone-800 dark:text-stone-200 mb-3">Forge a New Phrase</h1>
            <p className="text-stone-500 dark:text-stone-400 font-serif italic text-sm">Seal your new destiny below.</p>
          </div>
