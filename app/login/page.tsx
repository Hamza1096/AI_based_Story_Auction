...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-[#0c1222] text-stone-800 font-sans selection:bg-amber-800/20">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-[#Fdfbf7] dark:bg-[#181615] transition-colors duration-500">
        ...
        <div className="w-full max-w-md relative z-10 p-8 sm:p-12 rounded-sm bg-white/60 dark:bg-black/20 shadow-2xl shadow-stone-200/50 dark:shadow-none border border-stone-200/60 dark:border-stone-800/40">
          
          <div className="mb-10 text-center">
            <h1 className="font-serif text-3xl text-stone-800 dark:text-stone-200 mb-3">Return to Your Story</h1>
            <p className="text-stone-500 dark:text-stone-400 font-serif italic">Turn the page to continue your journey.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end pt-1 pb-4">
              <Link href="/forgot-password" className="text-xs text-stone-500 hover:text-amber-700 dark:hover:text-amber-500 transition-colors font-serif italic">
                Lost your place?
              </Link>
            </div>
