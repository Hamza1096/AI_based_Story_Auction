      ...
      <div className="w-full max-w-md relative z-10 p-8 sm:p-12 rounded-sm bg-[#181615] shadow-2xl border border-stone-800/40">
        ...
        <div className="relative z-10">
          <div className="mb-10 text-center">
            <h1 className="font-serif text-3xl text-stone-200 mb-3">Lost Your Place?</h1>
            <p className="text-stone-400 font-serif italic text-sm">Provide the parchment containing your inscribed email.</p>
          </div>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/login"
              className="text-sm text-amber-500 hover:text-amber-400 font-serif border-b border-transparent hover:border-amber-500 pb-0.5 italic transition-colors"
            >
