...
- **Global scope**: `E:/Projects/AI_Auction/ai-auction/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/Projects/AI_Auction/ai-auction/.opencode/notes/`)
...
2. Glob `E:/Projects/AI_Auction/ai-auction/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (E:/Projects/AI_Auction/ai-auction/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/Projects/AI_Auction/ai-auction/.opencode/notes/` — works in any directory
