...
```bash
AUDITOR_MODEL=$(node "E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read E:/Projects/AI_Auction/ai-auction/.opencode/agents/gsd-eval-auditor.md for instructions.
