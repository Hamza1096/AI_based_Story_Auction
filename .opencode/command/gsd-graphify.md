...
Knowledge graph is disabled. To activate:
  ...
  node E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
