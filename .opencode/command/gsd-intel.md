...
Intel system is disabled. To activate:
  ...
  node E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
