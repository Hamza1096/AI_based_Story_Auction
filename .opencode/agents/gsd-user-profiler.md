...
<reference>
@E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/references/user-profiling.md` to load:
