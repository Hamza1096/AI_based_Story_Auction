...
Use template from `E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
