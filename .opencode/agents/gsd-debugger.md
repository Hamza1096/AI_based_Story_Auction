...
<required_reading>
@E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/Projects/AI_Auction/ai-auction/.opencode
                  → checks E:/Projects/AI_Auction/ai-auction/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done
                  → writes to E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/hooks/
...
@E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/Projects/AI_Auction/ai-auction/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
